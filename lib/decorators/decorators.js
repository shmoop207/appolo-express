...
exports.define = function (id) {
    return function (id, fn) {
        var appoloDef = appolo.define(id || (fn.name.charAt(0).toLowerCase() + fn.name.slice(1)), fn);
...
exports.alias = function (alias,indexBy) {
    return addDefinitionClass("alias", [alias,indexBy]);
}


exports.aliasFactory = function (aliasFactory,indexBy) {

    return addDefinitionClass("aliasFactory", [aliasFactory,indexBy]);
}
