...
class Launcher extends appolo.EventDispatcher {
    ...
    launch(config, callback) {
        ...
        return Q.try(this.loadOptions.bind(this), config)
            ...
            .then(this.setPort.bind(this))
            .then(this.loadDefaultConfigurations.bind(this))
            .then(this.loadCustomConfigurations.bind(this))
    ...
    loadCustomConfigurations() {
        ...
        [allPath, environmentPath].forEach(function (filePath) {
    ...
    startServer() {
        return Q.promisify(this.app.server.listen, this.app.server)(this.app.get('port'))
