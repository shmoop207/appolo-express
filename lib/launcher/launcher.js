...
var Launcher = appolo.EventDispatcher.define({
    ...
    startServer: function (callback) {
       ...
       this._app.server.listen(this._app.get('port'), this._onServerLoad.bind(this,callback));
    },
    ...
    reset:function(){
        ...
        try{this._app.server.close();} catch(e){console.log("failed to close server",e)}
